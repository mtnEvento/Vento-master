...
public class ReservedDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( reservedSeatData != null){
            ...
            ((TextView) findViewById(R.id.reserved_evt_description)).setText((reservedSeatData.getEvent().getDescription() == null || reservedSeatData.getEvent().getDescription().contains("null") || reservedSeatData.getEvent().getDescription().isEmpty()) ? "No description" : reservedSeatData.getEvent().getDescription());
        }
